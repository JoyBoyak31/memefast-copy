...
/**
 * WebSocket proxy server for Pump.fun
 * 
 * This server creates a bridge between the frontend and Pump.fun's WebSocket service
 * It handles:
 * 1. Connection to Pump.fun WebSocket 
 * 2. Forwarding messages to clients
 * 3. Subscribing to token updates
 * 4. Fallback to simulation when real connection not available
 */
...
function startSimulatedUpdates() {
  ...
  }, 1500); // Every 1.5 seconds for more frequent updates
}
